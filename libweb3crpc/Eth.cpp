...
Eth::Eth(CI::cic::Interface& _eth, CI::cic::AccountHolder& _ethAccounts):
    m_eth(_eth),
...
{
    return toJS(CI::cic::c_protocolVersion);
}
...
{
    cout<<"Enter eth_getBalance():"<<_address<<endl;
    try
    {
...
{
    CI::cic::SyncStatus sync = client()->syncStatus();
