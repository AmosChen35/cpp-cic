...
Json::Value toJson(CI::cic::BlockHeader const& _bi, SealEngineFace* _sealer)
{
    Json::Value res;
    if (_bi)
    {
...
Json::Value toJson(CI::cic::Transaction const& _t, std::pair<h256, unsigned> _location, BlockNumber _blockNumber)
{
    Json::Value res;
    if (_t)
    {
...
Json::Value toJson(CI::cic::BlockHeader const& _bi, BlockDetails const& _bd, UncleHashes const& _us, Transactions const& _ts, SealEngineFace* _face)
{
...
Json::Value toJson(CI::cic::BlockHeader const& _bi, BlockDetails const& _bd, UncleHashes const& _us, TransactionHashes const& _ts, SealEngineFace* _face)
{
    Json::Value res = toJson(_bi, _face);
    if (_bi)
    {
...
Json::Value toJson(CI::cic::TransactionSkeleton const& _t)
{
    Json::Value res;
...
Json::Value toJson(CI::cic::TransactionReceipt const& _t)
{
    Json::Value res;
    if (_t.hasStatusCode())
    ...
    res["log"] = CI::col::toJson(_t.log());
    return res;
}

Json::Value toJson(CI::cic::LocalisedTransactionReceipt const& _t)
{
    Json::Value res;
    ...
    res["logs"] = CI::col::toJson(_t.localisedLogs());
...
Json::Value toJson(CI::cic::Transaction const& _t)
{
    Json::Value res;
...
Json::Value toJson(CI::cic::LocalisedTransaction const& _t)
{
    Json::Value res;
    if (_t)
    {
...
Json::Value toJson(CI::cic::LocalisedLogEntry const& _e)
{
    Json::Value res;
    ...
    {
        res = toJson(static_cast<CI::cic::LogEntry const&>(_e));
...
Json::Value toJson(CI::cic::LogEntry const& _e)
{
    Json::Value res;
...
Json::Value toJson(std::unordered_map<h256, CI::cic::LocalisedLogEntries> const& _entriesByBlock, vector<h256> const& _order)
{
...
Json::Value toJsonByBlock(LocalisedLogEntries const& _entries)
{
    ...
    for (CI::cic::LocalisedLogEntry const& e: _entries)
    {
...
CI::cic::LogFilter toLogFilter(Json::Value const& _json)
{
    CI::cic::LogFilter filter;
    if (!_json.isObject() || _json.empty())
        return filter;
...
CI::cic::LogFilter toLogFilter(Json::Value const& _json, Interface const& _client) // commented to avoid warning. Uncomment once in use @ PoC-7.
{
    CI::cic::LogFilter filter;
    if (!_json.isObject() || _json.empty())
        return filter;
