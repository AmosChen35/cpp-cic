#ifndef LIBCOLCORE_FIXEDHASH_H
#define LIBCOLCORE_FIXEDHASH_H
...
public:
    ...
    explicit FixedHash(std::string const& _s, ConstructFromStringType _t = FromHex, ConstructFromHashType _ht = FailIfDifferent): FixedHash(_t == FromHex ? fromHex(_s, WhenError::Throw) : col::asBytes(_s), _ht) {}
