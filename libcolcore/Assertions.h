#ifndef LIBCOLCORE_ASSERTIONS_H
#define LIBCOLCORE_ASSERTIONS_H
...
#define asserts(A) assertAux(A, #A, __LINE__, __FILE__, ETH_FUNC)
#define assertsEqual(A, B) ::CI::col::assertEqualAux(A, B, #A, #B, __LINE__, __FILE__, ETH_FUNC)
...
#define assertThrow(_condition, _ExceptionType, _description) \
    ::CI::col::assertThrowAux<_ExceptionType>(_condition, _description, __LINE__, __FILE__, ETH_FUNC)
...
)
{
    if (!_condition)
        ::boost::throw_exception(
            _ExceptionType() <<
            ::CI::col::errinfo_comment(_errorDescription) <<
