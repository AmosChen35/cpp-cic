#include "libcolcrypto.h"

static_assert(CRYPTOPP_VERSION == 565, "Wrong Crypto++ version");
static_assert(CI::col::Secret::size == 32, "Secret key must be 32 bytes.");
static_assert(CI::col::Public::size == 64, "Public key must be 64 bytes.");
static_assert(CI::col::Signature::size == 65, "Signature must be 65 bytes.");

using namespace CI::col;
using namespace CI::col::crypto;
