#ifndef CIC_MINERAUX_H
#define CIC_MINERAUX_H

#include <boost/algorithm/string/case_conv.hpp>
#include <libcolcore/CommonJS.h>
#include <libcicore/Exceptions.h>
#include <libcic/BasicAuthority.h>
#include <libcihashseal/Ethash.h>
#include <libcihashseal/EthashCPUMiner.h>
...
inline std::string credits()
{
    ...
    out << "Cell Intelligent Coin" << CI::col::Version << endl
        << "   By CIC contributors, (c) 2013-2018." << endl
