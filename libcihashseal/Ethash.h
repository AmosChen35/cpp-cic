#ifndef LIBCIHASHSEAL_ETHASH_H
#define LIBCIHASHSEAL_ETHASH_H
...
public:
    ...
    CI::cic::GenericFarm<EthashProofOfWork>& farm() { return m_farm; }
...
private:
    ...
    CI::cic::GenericFarm<EthashProofOfWork> m_farm;
