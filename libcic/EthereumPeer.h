#ifndef LIBCIC_ETHEREUMPEER_H
#define LIBCIC_ETHEREUMPEER_H
 ...
 */
class EthereumPeer: public CI::cnet::Capability
{
...
public:
    /// Basic constructor.
    EthereumPeer(std::shared_ptr<CI::cnet::SessionFace> _s, CI::cnet::HostCapabilityFace* _h, unsigned _i, CI::cnet::CapDesc const& _cap);
    ...
    CI::cnet::NodeID id() const { return session()->id(); }
...
private:
    using CI::cnet::Capability::sealAndSend;
