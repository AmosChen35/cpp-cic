#ifndef LIBCIC_BLOCKDETAILS_H
#define LIBCIC_BLOCKDETAILS_H
...
struct BlockLogBlooms
{
    ...
    bytes rlp() const { bytes r = CI::col::rlp(blooms); size = r.size(); return r; }
...
struct BlockHash
{
    ...
    bytes rlp() const { return CI::col::rlp(value); }
