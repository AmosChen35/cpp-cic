#ifndef LIBCIC_CLIENT_H
#define LIBCIC_CLIENT_H
...
public:
    ...
    /// Get the block.
    CI::cic::Block block(h256 const& _blockHash, PopulationStatistics* o_stats) const;

    /// Get the object representing the current state of Ethereum.
    CI::cic::Block postState() const { ReadGuard l(x_postSeal); return m_postSeal; }
    ...
    */
    ...
    //FIXME
    /*
    std::unique_ptr<StateImporterFace> createStateImporter() { return CI::cic::createStateImporter(m_stateDB); }
    std::unique_ptr<BlockChainImporterFace> createBlockChainImporter() { return CI::cic::createBlockChainImporter(m_bc); }
    */
...
protected:
    ...
    void init(CI::cnet::Host* _extNet, boost::filesystem::path const& _dbPath,
