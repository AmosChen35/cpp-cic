#ifndef LIBCIC_LOGFILTER_H
#define LIBCIC_LOGFILTER_H
...
std::ostream& operator<<(std::ostream& _out, CI::cic::LogFilter const& _s);
...
public:
    ...
    friend std::ostream& CI::cic::operator<<(std::ostream& _out, CI::cic::LogFilter const& _s);
