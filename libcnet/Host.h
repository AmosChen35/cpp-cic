#ifndef LIBCNET_HOST_H
#define LIBCNET_HOST_H
...
*/
    ...
    bool haveNetwork() const {
        Guard l(x_runTimer);
        //FIXME Guard ll(x_nodeTable);
        //FIXME return m_run && !!m_nodeTable; }
        return m_run; }
...
*/
    ...
    CI::cnet::NodeInfo nodeInfo() const { return NodeInfo(id(), (networkPreferences().publicIPAddress.empty() ? m_tcpPublic.address().to_string() : networkPreferences().publicIPAddress), m_tcpPublic.port(), m_clientVersion); }
...
*/
    ...
    Logger m_logger{createLogger(VerbosityDebug, "cnet")};
};

#endif //LIBCNET_HOST_H
